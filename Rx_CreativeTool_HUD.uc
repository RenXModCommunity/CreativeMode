class Rx_CreativeTool_HUD extends Rx_HUD;

var int DefaultTargettingRangex, pageNum;
var privatewrite Rx_CreativeTool_HUDC AdminHud;
...
{
	local Rx_CreativeTool_Controller PC;

	if (!OpenMenu) return;

	PC = Rx_CreativeTool_Controller(PlayerOwner);
...
function CreateHudCompoenents()
{
	...
	AdminHud = New class'Rx_CreativeTool_HUDC';
}
